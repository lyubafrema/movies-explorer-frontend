    ...
    <section className="student">
      ...
      <ul className='student__portfolio_list'>
        <li className='student__portfolio_item'>
          <a className='student__portfolio_link' href="https://github.com/lyubafrema/how-to-learn" target='blanc'>
            <p className='student__portfolio_link-text'>Статичный сайт</p>
            <span>↗</span>
          </a>
        </li>
        <li className='student__portfolio_item'>
          <a className='student__portfolio_link' href="https://lyubafrema.github.io/russian-travel/" target='blanc'>
            <p className='student__portfolio_link-text'>Адаптивный сайт</p>
            <span>↗</span>
          </a>
        </li>
        <li className='student__portfolio_item'>
          <a className='student__portfolio_link' href="https://lyubafrema.nomoredomains.monster/" target='blanc'>
            <p className='student__portfolio_link-text'>Одностраничное приложение</p>
            <span>↗</span>
          </a>
        </li>
      </ul>
